...
public class SystemPropertyAccess {
    ...
    public static String getModelCode(){
        try {
            Class SystemProperties = Class.forName("android.os.SystemProperties");
            String name="ro.hsm.extconf.num";
    ...
    public static void mysendBroadcast(Context context, Intent intent){
        ...
        if(sdkVersion<26) {
            ...
            sendImplicitBroadcast(context.getApplicationContext(), intent);
        }
